...
EXT4_BLOCKDEV_STATIC_INSTANCE(ext4_blockdev, EXT4_BLOCKDEV_BSIZE, EXT4_BLOCKDEV_SIZE / EXT4_BLOCKDEV_BSIZE, __blockdev_open, __blockdev_bread, __blockdev_bwrite, __blockdev_close, 0, 0);
