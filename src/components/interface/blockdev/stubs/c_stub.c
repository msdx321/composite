...
COS_CLIENT_STUB(unsigned long, blockdev_bread)(struct usr_inv_cap *uc, const void *buf, unsigned long offset, unsigned long length) {
	word_t unused;
    int c;
    unsigned long ret;
...
COS_CLIENT_STUB(unsigned long, blockdev_bwrite)(struct usr_inv_cap *uc, const void *buf, unsigned long offset, unsigned long length) {
	word_t unused;
    int c;
    unsigned long ret;
